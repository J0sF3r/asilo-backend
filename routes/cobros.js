...
//Registrar un cobro por Tratamiento Fijo en la tabla unificada
router.post('/', farmaciaAuth, async (req, res) => {
    const { id_tratamiento_fijo, cantidad_dispensada, costo_total } = req.body;

    try {
        // Obtener la información  del tratamiento fijo
        ...
        //Buscamos al familiar principal para asignarle el cobro
